...
function Concluido() {
  ...
  async function getPdf() {
    ...
    try {
      const pdf = `https://webapi.monzoyetu.com/api/v1/list_visitas_/1/concluidas?data_de=${from}&data_ate=${to}&categoria=${cat}&sub_categoria=${subcat}&morador=${morad}&export=pdf`;
      setpdf(pdf);
  ...
  async function getExcel() {
    console.log('ok', from, to, cat, subcat,morad);
    try {
      const excel = `https://webapi.monzoyetu.com/api/v1/list_visitas_/1/concluidas?data_de=${from}&data_ate=${to}&categoria=${cat}&sub_categoria=${subcat}&morador=${morad}&export=excel`;
      setexcel(excel);
  ...
  async function handleChangeFilterByDateFromTo() {
    ...
    try {
      ...
      const response = await api.get(`v1/list_visitas/1/concluidas?data_de=${from}&data_ate=${to}&categoria=${cat}&sub_categoria=${subcat}&morador=${morad}`);
  ...
  async function getAppointments() {
    try {
      const response = await api.get('v1/list_visitas/1/concluidas');
      setAppointments(response.data);
            ...
            <div className="container">
              ...
              <div className='mt-4'>
                <div className="btn-group w-max-1200 border-botton-right-0">
                  ...
                  <Link to="/concluido" className="btn border-botton-right-0 btn-light-tabs active">Concluido</Link>
